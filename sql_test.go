...
func TestExecSql(t *testing.T) {
	...
	_, err := db.ExecContext(ctx, query, "Failah", "Failah")
	if err != nil {
		panic(err)
	}
...
func TestExecSqlParameter(t *testing.T) {
	...
	username := "tahta'; DROP TABLE user; #"
	password := "tahta"
...
func TestPrepareStatement(t *testing.T) {
	...
	for i := 0; i < 10; i++ {
		email := "tahta" + strconv.Itoa(i) + "@gmail.com"
